...
public class UsageSoapBindingStub extends org.apache.axis.client.Stub implements com.calix.compass.fa.usage.v1.soap.Usage {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://soap.v1.usage.fa.compass.calix.com", "password"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
    ...
    public UsageSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://data.soap.v1.usage.fa.compass.calix.com", "IPDR");
            cachedSerQNames.add(qName);
            cls = com.calix.compass.fa.usage.v1.soap.data.IPDR.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://data.soap.v1.usage.fa.compass.calix.com", "IPDRX");
            cachedSerQNames.add(qName);
            cls = com.calix.compass.fa.usage.v1.soap.data.IPDRX.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {entityType, entityId, startTime, endTime, interval, dimension});
  ...
  throw axisFaultException;
    ...
    public com.calix.compass.fa.usage.v1.soap.data.IPDR[] getIPDR(java.lang.String endpoint, java.util.Calendar startTime, java.util.Calendar endTime, java.lang.String interval) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://soap.v1.usage.fa.compass.calix.com", "getIPDR"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {endpoint, startTime, endTime, interval});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (com.calix.compass.fa.usage.v1.soap.data.IPDR[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.calix.compass.fa.usage.v1.soap.data.IPDR[]) org.apache.axis.utils.JavaUtils.convert(_resp, com.calix.compass.fa.usage.v1.soap.data.IPDR[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
